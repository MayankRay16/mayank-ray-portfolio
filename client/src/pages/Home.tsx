  ...
  return <main className="site-shell">
    ...
    <section className="home-hero page-wrap">
      <div className="hero-copy">
        ...
        <p className="hero-intro">I’m Jaya — a CSE student, creative problem solver, and front-end builder crafting thoughtful digital experiences from Bangalore.</p>
      ...
      <div className="home-portrait-wrap">
        ...
        <div className="portrait-card">
          ...
          <img src={portraitUrl} alt="Jaya Kaushiki" className="portrait-image" />
          <div className="portrait-overlay" />
          <div className="portrait-name">JAYA<br /><em>KAUSHIKI</em></div>
    ...
    <footer className="site-footer page-wrap"><span>© 2026 JAYA KAUSHIKI</span><span>BUILT WITH CURIOSITY + CODE</span><a href="/contact" target="_blank" rel="noreferrer">NEXT / CONTACT <ArrowUpRight size={14} /></a></footer>
  </main>;
}
